...
// City and API key
const String keyAPI = "d3d5a692c789b153ef68a125bbbccfe9"; // Put here you API key found at your created account in api.openweathermap.org
const String city = "Ageo"; // What City the weather data should be based on
...
void loop() {
  ...
  if(WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("http://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=" + keyAPI + "&units=metric");
