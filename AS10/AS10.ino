...
// City and API key
const char* keyAPI = "yamachine"; // Put here you API key found at your created account in api.openweathermap.org
const char* city = "d719b2c69a22622d76127858343f8e5e"; // What City the weather data should be based on
...
void loop() {
  ...
  if(WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("http://api.openweathermap.org/data/2.5/weather?q=yamachine&appid=d719b2c69a22622d76127858343f8e5e&units=metric");
