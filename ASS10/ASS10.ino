...
void loop() {
  ...
  if(WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("http://api.openweathermap.org/data/2.5/weather?q=Tokyo&appid=d3d5a692c789b153ef68a125bbbccfe9&units=metric");
  ...
  // Delay
  delay(60000); // Get and parse response every 1 minute intervals
}